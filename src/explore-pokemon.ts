...
export function createTownPokemon(p:Place):TownPokemon {
  ...
  if(p.id==='tour_fuchsia')return {id:'tourPokemon',name:'돌봄길의 파치리스',species:'pachirisu',sprite:'field-pachirisu',x:12,y:29,facing:'right',dialogue:'tourPokemon',pages:['파치파치!\n돌봄 작업뜰로 이어진 길을 살핀다.','주민과 함께 지내는 생활 포켓몬이다.\n도시의 야생 조우 대상은 아니다.']};
  ...
  if(p.id==='tour_village_bridge')return {id:'tourPokemon',name:'다리 난간의 콩둘기',species:'pidove',sprite:'field-pidove',x:45,y:28,facing:'left',dialogue:'tourPokemon',pages:['구구구!\n수로에서 올라오는 바람에 몸을 돌리고 난간 안쪽에서 깃을 고른다.','보행 통로를 비켜 동료 휴게뜰 쪽으로 천천히 걸어간다.']};
  if(p.id==='tour_opelucid')return {id:'tourPokemon',name:'석조 광장의 콩둘기',species:'pidove',sprite:'field-pidove',x:32,y:16,facing:'left',dialogue:'tourPokemon',pages:['구구구.\n용 문양 기둥의 그늘에서 돌바닥 무늬를 살피고 있다.','사람이 지나오자 중앙 통행로를 비켜 낮은 돌 가장자리로 걸어간다.']};
  if(p.id==='tour_icirrus')return {id:'tourPokemon',name:'생활 뜰의 콩둘기',species:'pidove',sprite:'field-pidove',x:18,y:25,facing:'left',dialogue:'tourPokemon',pages:['구구구.\n빗물이 튀지 않는 마른 길 가장자리에서 깃을 고른다.','물그릇을 살핀 뒤 사람과 포켓몬의 통행선을 비켜 걷는다.']};
