...
const collections:Record<string,Collection>={
  ...
  pallet:{style:'lab',exhibits:[exhibit('console','기술 관찰 장치','동료의 기술과 상성을 비교하는\n모의 실험용 단말이다.'),exhibit('shelf','생태 연구 서가','포켓몬의 생활 환경을 기록한\n책과 노트가 꽂혀 있다.'),exhibit('plants','연구용 화분','작은 새싹 옆에 성장 날짜를\n적은 팻말이 꽂혀 있다.')]},
  viridian:{style:'garden',exhibits:[exhibit('plants','상록수 묘목','사계절 푸른 잎을 유지하는\n나무의 어린 묘목이다.'),exhibit('chart','숲 산책 지도','회색시티 방향의 짧은 숲길과\n쉼터가 표시되어 있다.'),exhibit('workbench','숲 관찰 수첩','숲에서 만난 포켓몬의 기록을\n내 도감과 비교하는 관찰 책상이다.')]},
