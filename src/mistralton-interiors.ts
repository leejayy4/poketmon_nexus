...
const ROLES:Record<string,Role>={
  tour_mistralton_hall:{title:'공항 터미널 1층 · 도착 안내',host:'공항 안내원',greeting:['전기돌동굴에서 도착한 여행자와 공항 견학자를 안내하는 로비입니다.','산로마을 왕복편은 로비의 조종사에게 물어보고, 다른 목적지는 운항표에 올리지 않습니다.'],objects:[['궐수 도착 안내도','남쪽 전기돌동굴, 북서쪽 센터와 상점, 동쪽 활주로 외곽 보행로가 표시돼 있다.'],['비행기 구조 모형','날개와 화물칸, 바퀴의 위치를 안전한 모형으로 살펴볼 수 있다.'],['터미널 층별 안내','1층 도착·산로행 안내 · 2층 화물과 기상 운영 · 3층 동행 휴게 전망실']]},
  tour_mistralton_hall_2f:{title:'공항 터미널 2층 · 화물·기상 운영실',host:'비행 운영 기록원',greeting:['활주로의 바람과 화물 적재 순서를 기록하는 작업층입니다.','적재표에서 동료를 정한 뒤 외부 적재장과 바람쉼터를 돌아오세요.'],objects:[['바람 관측판','활주로 표지탑이 가리킨 풍향과 시간대별 바람 세기가 기록돼 있다.'],['화물 적재표','동굴 광물 표본과 농산물 상자를 무게와 목적지별로 나눈 표다.'],['활주로 안전도','울타리 밖 보행로와 작업 구역, 포켓몬 쉼터의 경계가 표시돼 있다.']]},
