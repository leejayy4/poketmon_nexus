...
export function installSinnohSoutheastRoutes(args:{places:Place[];maps:Record<TourId,GameMap>;passages:Record<string,Passage>;passagePlaces:Record<string,Place>;spawns:Record<TourId,{x:number;y:number}>;features:Record<string,TourFeature[]>}){
  ...
  maps[SINNOH_ROUTE_213]={id:SINNOH_ROUTE_213,name:'신오 213번도로 · 해변길',width:72,height:32,background:SINNOH_ROUTE_213,walkable:r213.map(r=>r.join('')),terrain:[],warps:[{x:1,y:16,to:pastoria.id,spawn:{...pastLegacyEnd.spawn},entry:'left',facing:'left'},{x:70,y:12,to:VALOR_LAKEFRONT,spawn:{x:3,y:27},entry:'right',facing:'right'}],npcs:[{id:'route213Trainer',name:'213번도로 해변 트레이너',sprite:'ace_trainer_f',x:28,y:19,facing:'down',dialogue:'route213Trainer'},{id:'route213BeachCaretaker',name:'213번도로 해변 관리인',sprite:'worker',x:20,y:25,facing:'right',dialogue:'route213BeachCaretaker'}],props:[{x:5,y:12,dialogue:'route213Sign'},{x:64,y:8,dialogue:'route213Sign'}]};features[SINNOH_ROUTE_213]=f213;spawns[SINNOH_ROUTE_213]={x:3,y:16};
  ...
  maps[SINNOH_ROUTE_214]={id:SINNOH_ROUTE_214,name:'신오 214번도로 · 암벽길',width:32,height:80,background:SINNOH_ROUTE_214,walkable:r214.map(r=>r.join('')),terrain:[],warps:[{x:15,y:1,to:veilstone.id,spawn:{...veilLegacyEnd.spawn},entry:'up',facing:'up'},{x:22,y:78,to:VALOR_LAKEFRONT,spawn:{x:20,y:3},entry:'down',facing:'down'}],npcs:[{id:'route214Trainer',name:'214번도로 암벽 트레이너',sprite:'rancher',x:21,y:43,facing:'left',dialogue:'route214Trainer'}],props:[{x:20,y:7,dialogue:'route214Sign'},{x:17,y:72,dialogue:'route214Sign'}]};features[SINNOH_ROUTE_214]=f214;spawns[SINNOH_ROUTE_214]={x:15,y:3};
  ...
  maps[SINNOH_ROUTE_222]={id:SINNOH_ROUTE_222,name:'신오 222번도로 · 물가 해안길',width:80,height:32,background:SINNOH_ROUTE_222,walkable:r222.map(r=>r.join('')),terrain:[],warps:[{x:1,y:16,to:VALOR_LAKEFRONT,spawn:{x:35,y:36},entry:'left',facing:'left'},{x:78,y:12,to:sunyshore.id,spawn:{...sunLegacyEnd.spawn},entry:'right',facing:'right'}],npcs:[{id:'route222Trainer',name:'222번도로 해안 트레이너',sprite:'school_kid_f',x:47,y:19,facing:'up',dialogue:'route222Trainer'}],props:[{x:5,y:12,dialogue:'route222Sign'},{x:72,y:8,dialogue:'route222Sign'}]};features[SINNOH_ROUTE_222]=f222;spawns[SINNOH_ROUTE_222]={x:3,y:16};
