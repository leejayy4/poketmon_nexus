...
const trainers:PracticeTrainer[]=[
  ...
  {map:'tour_sinnoh_route_202',event:'route202TrainerBurmy',id:'sinnoh-route-202-burmy',name:'202번도로 소년',reward:80,team:[[412,5]],battlePage:'잔모래에서 올라왔구나!\n도롱충이와 겨뤄 보자!',localPages:['도롱충이와 잔모래 쪽 풀길을 살피고 있어.\n축복시티에 가기 전 한 번 겨뤄 볼래?','벌레 타입에 유리한 기술이 있다면 이번에 시험해 봐.','거절하거나 져도 북쪽 축복시티로 계속 갈 수 있어.']},
