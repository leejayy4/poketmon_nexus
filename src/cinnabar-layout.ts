...
// Safe footpaths split each existing habitat; stepping sideways still enters the same pool.
export const CINNABAR_GRASS=[
  {kind:'tallGrass' as const,x:36,y:28,w:2,h:2},{kind:'tallGrass' as const,x:39,y:28,w:3,h:2},
  {kind:'tallGrass' as const,x:5,y:30,w:2,h:3},{kind:'tallGrass' as const,x:8,y:30,w:2,h:3},
];
export const CINNABAR_HABITAT_PATHS=[
  {x:38,y:26,w:1,h:7},{x:7,y:29,w:1,h:5},{x:7,y:33,w:8,h:1},
];
export const CINNABAR_RESEARCH_ROCKS:TourFeature[]=[
