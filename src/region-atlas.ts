...
export const REGION_ATLASES:Record<string,RegionAtlas>={
  ...
  '성도':{
    ...
    points:{goldenrod:[98,126],violet:[158,102],azalea:[148,166],ilex:[112,158],ecruteak:[108,62],mahogany:[178,62],rage_lake:[178,30],olivine:[58,104],cianwood:[22,158],blackthorn:[230,62],cherrygrove:[180,158]},
  },
  '신오':{
    ...
    points:{jubilife:[68,132],oreburgh:[100,140],eterna_forest:[68,94],eterna:[100,86],celestic:[156,82],coronet:[128,114],hearthome:[156,130],veilstone:[204,90],pastoria:[180,154],canalave:[30,132],snowpoint:[136,24],sunyshore:[232,144],lake:[84,34]},
  },
  '하나':{
