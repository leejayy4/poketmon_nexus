...
- 적용·차이: 천관산211 두 지층 기록을 같은 동료와 유적 모사대에서 맞추는 프로젝트 선택 활동으로 연결했다. Pt의 오래된부적·갤럭시단/태홍 전투·파도타기 전달은 구현하거나 완료 처리하지 않는다. 세부 적용과 미검증 경계는 [신오 후속 기록](autonomy/sinnoh-continuation-20260915.md)을 따른다.
